    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {list.length > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-xl text-white/40 hover:text-red-400 hover:bg-red-500/10 text-xs font-medium transition-all"
          >
            <Trash2 size={13} />
            Clear all
          </button>
      ...
      {list.length === 0 && (
        ...
        >
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary/15 text-primary text-sm font-medium hover:bg-primary/25 transition-all"
          >
          ...
          return (
            ...
            >
              <div className="p-5">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="w-7 h-7 rounded-full bg-primary/15 flex items-center justify-center text-primary hover:bg-red-500/15 hover:text-red-400 transition-all"
                    >
                ...
                {/* Arabic */}
                <p dir="rtl" className="font-arabic text-xl text-white leading-loose text-right mb-3">
                  {item.arabic}
                </p>
